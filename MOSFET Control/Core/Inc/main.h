...
#define HVC__Pin GPIO_PIN_0
#define HVC__GPIO_Port GPIOC
#define HVC_C1_Pin GPIO_PIN_1
#define HVC_C1_GPIO_Port GPIOC
#define P_CHARGE_Pin GPIO_PIN_2
#define P_CHARGE_GPIO_Port GPIOC
#define CHARGE__Pin GPIO_PIN_3
#define CHARGE__GPIO_Port GPIOC
...
#define CHARGE_C4_Pin GPIO_PIN_4
#define CHARGE_C4_GPIO_Port GPIOC
...
#define HV_SENSE_Pin GPIO_PIN_10
